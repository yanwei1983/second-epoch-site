...
export default function Home(){
  ...
  return <main className="epoch-site">
    ...
    <section data-scroll-page className="transition-page quote-page"><div className="transition-overlay"><div className="quote-rotation"><article style={{'--q':.28}}><span>INTERSTELLAR CODEX / PREFACE</span><blockquote>“这里没有正义，只有胜者与败者。<br/>我们在深空中书写自己的法则。”</blockquote><p>— 《星际法典》引言</p></article><article style={{'--q':.5}}><span>IRON BLOOD ARCHIVE / 06</span><blockquote>“每一艘战舰都是一颗星辰，<br/>而你的舰队就是整片银河。”</blockquote><p>— 铁血军团元帅 索尔·瓦伦</p></article><article style={{'--q':.72}}><span>DEEP SPACE BROADCAST / RED FOX</span><blockquote>“虚空从不仁慈，但虚空从不说谎。<br/>在黑暗中，真相反而更加清晰。”</blockquote><p>— 星空海盗王 红狐</p></article></div></div></section>
